...
const makeBattle = (
  ...
  return {
    ...
    ...gzoneClashData[slug],
    archiveStatus: archivedGzoneBattleSlugs.has(slug) ? "complete" : "in-progress",
  };
};

export const gzoneBattles: Battle[] = [
  makeBattle("1x01", "Deeno", "Tapped24", "53.7K", "2025-12-25", "Deeno", "https://www.youtube.com/watch?v=09ZD_UjdoVw"),
  makeBattle("1x02", "PR1NC3", "Roman", "23.8K", "2026-01-01", "Roman", "https://www.youtube.com/watch?v=QByqdZAF3L0"),
  makeBattle("1x03", "LDN MIKEZ", "Deluxx", "16.1K", "2026-01-08", "LDN MIKEZ", "https://www.youtube.com/watch?v=RhC2D3ftzZo"),
  makeBattle("1x04", "LDN MIKEZ", "2MWAD", "23.7K", "2026-01-15", "LDN MIKEZ", "https://www.youtube.com/watch?v=NEiGspeXLYM"),
  makeBattle("1x05", "CJ Zino", "Proty", "11.0K", "2026-02-15", "Proty", "https://www.youtube.com/watch?v=T0zo6YgfxB4"),
  ...
  makeBattle("1x08", "2MWAD", "Ryno", "26.0K", "2026-02-19", "2MWAD", "https://www.youtube.com/watch?v=HfO3UR_Zeyk"),
  makeBattle("1x09", "Tapped24", "Roman", "16.9K", "2026-03-04", "Roman", "https://www.youtube.com/watch?v=OGagI2K6StY"),
  makeBattle("1x10", "Tapped24", "AJNA", "13.5K", "2026-03-19", "AJNA", "https://www.youtube.com/watch?v=oUDDrQtoTHM"),
  makeBattle("1x11", "Ryno", "Tymeless", "15.4K", "2026-03-26", "Tymeless", "https://www.youtube.com/watch?v=Omge-TNTrhQ"),
  makeBattle("1x12", "PR1NC3", "NattyEBK", "8.9K", "2026-04-02", "NattyEBK", "https://www.youtube.com/watch?v=Rs3kTPbnUm4"),
  makeBattle("1x13", "Btizz", "CJ Zino", "6.7K", "2026-04-09", "CJ Zino", "https://www.youtube.com/watch?v=-bKXRy3RxoY"),
  makeBattle("1x14", "Deeno", "Grams", "21.2K", "2026-04-26", "Deeno", "https://www.youtube.com/watch?v=OuVeBAU1OQQ"),
  makeBattle("1x15", "Tapped24", "Grams", "12.7K", "2026-04-26", "Tapped24", "https://www.youtube.com/watch?v=9gkXN1ZJeP8"),
  makeBattle("1x16", "Btizz", "1Flaymr", "8.0K", "2026-04-26", "Btizz", "https://www.youtube.com/watch?v=2lFLlylG5NQ"),
  makeBattle("1x17", "Deeno", "Badee Harz", "31.5K", "2026-05-23", "Deeno", "https://www.youtube.com/watch?v=yCkMZvg-cUg"),
  makeBattle("1x18", "Ryno", "Roman", "12.0K", "2026-04-26", "Roman", "https://www.youtube.com/watch?v=eNusiS3fDhw"),
  ...
  makeBattle("1x21", "Deeno", "Tymeless", "18.2K", "2026-05-31", "Tymeless", "https://www.youtube.com/watch?v=JoW3ZGND5YM"),
];
