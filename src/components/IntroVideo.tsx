          ...
          >
            ...
            <div className="mb-10">
              <h1 className="text-3xl md:text-6xl font-display italic leading-[1.1] uppercase mb-4 tracking-tight">
                Rising from the <span className="text-brand">ashes</span>, the UK’s rawest battle platform.
              </h1>
            </div>
            
            <p className="text-zinc-200 text-lg max-w-xl mb-10 leading-relaxed">
              No politics. No protection. You either perform… or you get performed on
            </p>
