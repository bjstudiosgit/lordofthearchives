          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-12">
                ...
                <StatBadge icon={<Trophy size={14} />} label={`${mc.wins}-${mc.losses} RECORD`} highlight />
                <StatBadge icon={<Zap size={14} />} label={`${mc.battles} BATTLES`} />
                <StatBadge icon={<Zap size={14} />} label={mc.style.toUpperCase()} />
              </div>
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 rounded-xl overflow-hidden border border-white/10">
                            <img 
                              src={opponent?.image || "https://picsum.photos/seed/opponent/100/100"} 
                              alt={opponent?.name}
                              className="w-full h-full object-cover"
                              referrerPolicy="no-referrer"
                            />
                          ...
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">VS Opponent</span>
                              {isWinner && (
