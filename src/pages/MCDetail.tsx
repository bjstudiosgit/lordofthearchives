...
export default function MCDetail() {
  ...
  const mcBattles = battles.filter(
    (b) => b.mc1 === mc.id || b.mc2 === mc.id || b.mc3 === mc.id || b.mc4 === mc.id
  );
