...
export default function League() {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="pt-32 min-h-screen">
                ...
                >
                  ...
                  >
                    <div className="relative">
                      <div
                        className={`w-12 h-12 rounded-xl bg-zinc-800 border ${
                          index === 0 ? "border-brand shadow-[0_0_15px_rgba(242,125,38,0.2)]" : "border-white/10"
                        } flex items-center justify-center font-bold text-brand text-xl italic`}
                      >
                        {mc.name[0]}
                      </div>
                      <div
                        className={`absolute -top-2 -left-2 w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black border ${
                          index === 0
                    ...
                    <div>
                      <h4 className="font-display italic uppercase text-lg group-hover:text-brand transition-colors">
                        {mc.name}
                      </h4>
