...
import DontFlopPage from "./pages/DontFlopPage";
import MCDetail from "./pages/MCDetail";
import MCIndex from "./pages/MCIndex";
import LordOfTheMicsPage from "./pages/LordOfTheMicsPage";
import PengameLeague from "./pages/PengameLeague";
  ...
  return (
    <div className="min-h-screen bg-zinc-950 selection:bg-brand selection:text-black">
      ...
      <Routes>
        ...
        <Route path="/pengame-league" element={<PengameLeague />} />
        <Route path="/pengame" element={<PengamePage />} />
        <Route path="/dont-flop" element={<DontFlopPage />} />
        <Route path="/lord-of-the-mics" element={<LordOfTheMicsPage />} />
